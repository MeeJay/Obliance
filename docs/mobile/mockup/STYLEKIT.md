...
#### `server-tile` — server identity (multi-server only, ≥ 2 servers configured). Colour + 2-letter monogram tile; the shape tells identity from status. 20px default, 18px in dense rows / card overlines, 28px in list rows (13px letters). Background = colour at 18 % over an opaque `#0F1220` base (keeps the 10px letters ≥ 4.5:1 on any surface, even `#222740`), 1px border at 40 %, letters JetBrains Mono 600. Closed palette (never brand red, never status colours): `#A78BFA` violet · `#2DD4BF` teal · `#E879F9` fuchsia · `#818CF8` indigo · `#67E8F9` cyan · `#D6B98C` sable · `#C4B5FD` lavande · `#5EEAD4` menthe. Reference servers: BinaryHearts `BH` violet, Atelier `AT` teal, Client Durand `CD` fuchsia. Add `role="img" aria-label="Serveur …"` when the name is not written next to it.
```html
<span aria-hidden="true" style="flex:none;display:inline-flex;align-items:center;justify-content:center;width:20px;height:20px;box-sizing:border-box;border-radius:5px;background:linear-gradient(rgba(167,139,250,.18),rgba(167,139,250,.18)),#0F1220;border:1px solid rgba(167,139,250,.40);color:#A78BFA;font:600 10px/1 'JetBrains Mono',ui-monospace,monospace;letter-spacing:0;text-transform:none">BH</span>
<span role="img" aria-label="Serveur Atelier" style="flex:none;display:inline-flex;align-items:center;justify-content:center;width:18px;height:18px;box-sizing:border-box;border-radius:5px;background:linear-gradient(rgba(45,212,191,.18),rgba(45,212,191,.18)),#0F1220;border:1px solid rgba(45,212,191,.40);color:#2DD4BF;font:600 10px/1 'JetBrains Mono',ui-monospace,monospace;letter-spacing:0;text-transform:none">AT</span>
<span aria-hidden="true" style="flex:none;display:inline-flex;align-items:center;justify-content:center;width:28px;height:28px;box-sizing:border-box;border-radius:5px;background:linear-gradient(rgba(232,121,249,.18),rgba(232,121,249,.18)),#0F1220;border:1px solid rgba(232,121,249,.40);color:#E879F9;font:600 13px/1 'JetBrains Mono',ui-monospace,monospace;letter-spacing:0;text-transform:none">CD</span>
```
...
```html
<a href="TenantSwitch.dc.html" aria-label="Périmètre : BinaryHearts, Default, vue globale" style="display:flex;align-items:center;height:48px;min-width:0"><span style="display:inline-flex;align-items:center;gap:8px;height:36px;padding:0 10px;border-radius:8px;background:#1D2238;color:#F0F4FC;white-space:nowrap"><span aria-hidden="true" style="flex:none;display:inline-flex;align-items:center;justify-content:center;width:20px;height:20px;box-sizing:border-box;border-radius:5px;background:linear-gradient(rgba(167,139,250,.18),rgba(167,139,250,.18)),#0F1220;border:1px solid rgba(167,139,250,.40);color:#A78BFA;font:600 10px/1 'JetBrains Mono',ui-monospace,monospace;letter-spacing:0;text-transform:none">BH</span><span style="font:500 14px/20px Inter,system-ui,sans-serif">Default</span><span style="font:400 11px/14px 'JetBrains Mono',ui-monospace,monospace;letter-spacing:.08em;text-transform:uppercase;color:#B4BCD7;background:#2A3048;border-radius:4px;padding:1px 5px">Vue globale</span><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#828CAF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" style="display:block;flex:none"><path d="m6 9 6 6 6-6"></path></svg></span></a>
```
...
<label style="display:block">
  <span style="display:flex;flex-direction:column;justify-content:center;height:56px;padding:0 12px;box-sizing:border-box;border-radius:6px;background:#181C30">
    ...
    <input type="text" value="obliance.binaryhearts.me" style="width:100%;padding:0;border:0;outline:none;background:transparent;color:#F0F4FC;font:400 16px/24px Inter,system-ui,sans-serif">
  </span>
