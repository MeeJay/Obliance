...
export const cisWindowsL1Rules: ComplianceRule[] = [
  ...
  r('cis-l1-1-2-1', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '$f="$env:TEMP\\sc$(Get-Random).cfg";secedit /export /cfg $f /quiet;$line=(Select-String \'LockoutDuration\' $f);Remove-Item $f -Force;$v=[int](($line.ToString() -split \'=\')[1].Trim());if($v -ge 15){\'PASS\'}else{\'FAIL\'}',
    expected: 'PASS',
    operator: 'eq',
    severity: 'moderate',
    remediationScript: '$f="$env:TEMP\\sc$(Get-Random).cfg";$db="$env:TEMP\\sc$(Get-Random).sdb";\'[System Access]\',\'LockoutDuration = 15\' | Set-Content $f;secedit /configure /db $db /cfg $f /areas SECURITYPOLICY /quiet;Remove-Item $f,$db -Force -EA 0',
  }),
  ...
  r('cis-l1-1-2-2', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '$f="$env:TEMP\\sc$(Get-Random).cfg";secedit /export /cfg $f /quiet;$line=(Select-String \'LockoutBadCount\' $f);Remove-Item $f -Force;$v=[int](($line.ToString() -split \'=\')[1].Trim());if($v -le 5 -and $v -gt 0){\'PASS\'}else{\'FAIL\'}',
    expected: 'PASS',
    operator: 'eq',
    severity: 'high',
    remediationScript: '$f="$env:TEMP\\sc$(Get-Random).cfg";$db="$env:TEMP\\sc$(Get-Random).sdb";\'[System Access]\',\'LockoutBadCount = 5\' | Set-Content $f;secedit /configure /db $db /cfg $f /areas SECURITYPOLICY /quiet;Remove-Item $f,$db -Force -EA 0',
  }),
  ...
  r('cis-l1-1-2-4', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '$f="$env:TEMP\\sc$(Get-Random).cfg";secedit /export /cfg $f /quiet;$line=(Select-String \'ResetLockoutCount\' $f);Remove-Item $f -Force;$v=[int](($line.ToString() -split \'=\')[1].Trim());if($v -ge 15){\'PASS\'}else{\'FAIL\'}',
    expected: 'PASS',
    operator: 'eq',
    severity: 'moderate',
    remediationScript: '$f="$env:TEMP\\sc$(Get-Random).cfg";$db="$env:TEMP\\sc$(Get-Random).sdb";\'[System Access]\',\'ResetLockoutCount = 15\' | Set-Content $f;secedit /configure /db $db /cfg $f /areas SECURITYPOLICY /quiet;Remove-Item $f,$db -Force -EA 0',
  }),
  ...
  r('cis-l1-17-1-1', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(auditpol /get /subcategory:"{0CCE923F-69AE-11D9-BED3-505054503030}" /r | ConvertFrom-Csv | Select-Object -ExpandProperty "Inclusion Setting")',
  ...
  r('cis-l1-17-1-2', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(auditpol /get /subcategory:"{0CCE9242-69AE-11D9-BED3-505054503030}" /r | ConvertFrom-Csv | Select-Object -ExpandProperty "Inclusion Setting")',
    expected: 'Success and Failure',
    operator: 'eq',
    severity: 'high',
    remediationScript: 'auditpol /set /subcategory:"{0CCE9242-69AE-11D9-BED3-505054503030}" /success:enable /failure:enable',
  }),
  r('cis-l1-17-1-3', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(auditpol /get /subcategory:"{0CCE9240-69AE-11D9-BED3-505054503030}" /r | ConvertFrom-Csv | Select-Object -ExpandProperty "Inclusion Setting")',
    expected: 'Success and Failure',
    operator: 'eq',
    severity: 'high',
    remediationScript: 'auditpol /set /subcategory:"{0CCE9240-69AE-11D9-BED3-505054503030}" /success:enable /failure:enable',
  }),
  r('cis-l1-17-1-4', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(auditpol /get /subcategory:"{0CCE9241-69AE-11D9-BED3-505054503030}" /r | ConvertFrom-Csv | Select-Object -ExpandProperty "Inclusion Setting")',
    expected: 'Success and Failure',
    operator: 'eq',
    severity: 'moderate',
    remediationScript: 'auditpol /set /subcategory:"{0CCE9241-69AE-11D9-BED3-505054503030}" /success:enable /failure:enable',
  }),
  ...
  r('cis-l1-17-2-1', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(auditpol /get /subcategory:"{0CCE9239-69AE-11D9-BED3-505054503030}" /r | ConvertFrom-Csv | Select-Object -ExpandProperty "Inclusion Setting")',
    expected: 'Success and Failure',
    operator: 'eq',
    severity: 'moderate',
    remediationScript: 'auditpol /set /subcategory:"{0CCE9239-69AE-11D9-BED3-505054503030}" /success:enable /failure:enable',
  }),
  r('cis-l1-17-2-2', {
    ...
    operator: 'eq',
    severity: 'moderate',
    remediationScript: 'auditpol /set /subcategory:"{0CCE9236-69AE-11D9-BED3-505054503030}" /success:enable /failure:disable',
  }),
  r('cis-l1-17-2-3', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(auditpol /get /subcategory:"{0CCE9238-69AE-11D9-BED3-505054503030}" /r | ConvertFrom-Csv | Select-Object -ExpandProperty "Inclusion Setting")',
    expected: 'Success',
    operator: 'eq',
    severity: 'low',
    remediationScript: 'auditpol /set /subcategory:"{0CCE9238-69AE-11D9-BED3-505054503030}" /success:enable /failure:disable',
  }),
  r('cis-l1-17-2-4', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(auditpol /get /subcategory:"{0CCE923A-69AE-11D9-BED3-505054503030}" /r | ConvertFrom-Csv | Select-Object -ExpandProperty "Inclusion Setting")',
    expected: 'Success',
    operator: 'eq',
    severity: 'moderate',
    remediationScript: 'auditpol /set /subcategory:"{0CCE923A-69AE-11D9-BED3-505054503030}" /success:enable /failure:disable',
  }),
  r('cis-l1-17-2-5', {
    ...
    operator: 'eq',
    severity: 'high',
    remediationScript: 'auditpol /set /subcategory:"{0CCE9237-69AE-11D9-BED3-505054503030}" /success:enable /failure:disable',
  }),
  r('cis-l1-17-2-6', {
  ...
  r('cis-l1-17-3-1', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(auditpol /get /subcategory:"{0CCE9248-69AE-11D9-BED3-505054503030}" /r | ConvertFrom-Csv | Select-Object -ExpandProperty "Inclusion Setting")',
    expected: 'Success',
    operator: 'eq',
    severity: 'moderate',
    remediationScript: 'auditpol /set /subcategory:"{0CCE9248-69AE-11D9-BED3-505054503030}" /success:enable /failure:disable',
  }),
  r('cis-l1-17-3-2', {
    ...
    operator: 'eq',
    severity: 'high',
    remediationScript: 'auditpol /set /subcategory:"{0CCE922B-69AE-11D9-BED3-505054503030}" /success:enable /failure:disable',
  }),
  ...
  r('cis-l1-17-4-1', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(auditpol /get /subcategory:"{0CCE923B-69AE-11D9-BED3-505054503030}" /r | ConvertFrom-Csv | Select-Object -ExpandProperty "Inclusion Setting")',
    expected: 'Failure',
    operator: 'eq',
    severity: 'moderate',
    remediationScript: 'auditpol /set /subcategory:"{0CCE923B-69AE-11D9-BED3-505054503030}" /success:disable /failure:enable',
  }),
  r('cis-l1-17-4-2', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(auditpol /get /subcategory:"{0CCE923C-69AE-11D9-BED3-505054503030}" /r | ConvertFrom-Csv | Select-Object -ExpandProperty "Inclusion Setting")',
    expected: 'Success',
    operator: 'eq',
    severity: 'moderate',
    remediationScript: 'auditpol /set /subcategory:"{0CCE923C-69AE-11D9-BED3-505054503030}" /success:enable /failure:disable',
  }),
  ...
  r('cis-l1-17-5-1', {
    ...
    operator: 'eq',
    severity: 'high',
    remediationScript: 'auditpol /set /subcategory:"{0CCE9217-69AE-11D9-BED3-505054503030}" /success:disable /failure:enable',
  }),
  r('cis-l1-17-5-2', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(auditpol /get /subcategory:"{0CCE9249-69AE-11D9-BED3-505054503030}" /r | ConvertFrom-Csv | Select-Object -ExpandProperty "Inclusion Setting")',
    expected: 'Success',
    operator: 'eq',
    severity: 'moderate',
    remediationScript: 'auditpol /set /subcategory:"{0CCE9249-69AE-11D9-BED3-505054503030}" /success:enable /failure:disable',
  }),
  r('cis-l1-17-5-3', {
    ...
    operator: 'eq',
    severity: 'moderate',
    remediationScript: 'auditpol /set /subcategory:"{0CCE9216-69AE-11D9-BED3-505054503030}" /success:enable /failure:disable',
  }),
  r('cis-l1-17-5-4', {
  ...
  r('cis-l1-17-5-5', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(auditpol /get /subcategory:"{0CCE921C-69AE-11D9-BED3-505054503030}" /r | ConvertFrom-Csv | Select-Object -ExpandProperty "Inclusion Setting")',
    expected: 'Success and Failure',
    operator: 'eq',
    severity: 'moderate',
  ...
  r('cis-l1-17-5-6', {
    ...
    operator: 'eq',
    severity: 'high',
    remediationScript: 'auditpol /set /subcategory:"{0CCE921B-69AE-11D9-BED3-505054503030}" /success:enable /failure:disable',
  }),
  ...
  r('cis-l1-17-6-1', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(auditpol /get /subcategory:"{0CCE9244-69AE-11D9-BED3-505054503030}" /r | ConvertFrom-Csv | Select-Object -ExpandProperty "Inclusion Setting")',
    expected: 'Failure',
    operator: 'eq',
    severity: 'moderate',
    remediationScript: 'auditpol /set /subcategory:"{0CCE9244-69AE-11D9-BED3-505054503030}" /success:disable /failure:enable',
  }),
  r('cis-l1-17-6-2', {
  ...
  r('cis-l1-17-6-3', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(auditpol /get /subcategory:"{0CCE9227-69AE-11D9-BED3-505054503030}" /r | ConvertFrom-Csv | Select-Object -ExpandProperty "Inclusion Setting")',
    expected: 'Success and Failure',
    operator: 'eq',
    severity: 'moderate',
    remediationScript: 'auditpol /set /subcategory:"{0CCE9227-69AE-11D9-BED3-505054503030}" /success:enable /failure:enable',
  }),
  r('cis-l1-17-6-4', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(auditpol /get /subcategory:"{0CCE9245-69AE-11D9-BED3-505054503030}" /r | ConvertFrom-Csv | Select-Object -ExpandProperty "Inclusion Setting")',
    expected: 'Success and Failure',
    operator: 'eq',
    severity: 'high',
    remediationScript: 'auditpol /set /subcategory:"{0CCE9245-69AE-11D9-BED3-505054503030}" /success:enable /failure:enable',
  }),
  ...
  r('cis-l1-17-7-2', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(auditpol /get /subcategory:"{0CCE9230-69AE-11D9-BED3-505054503030}" /r | ConvertFrom-Csv | Select-Object -ExpandProperty "Inclusion Setting")',
    expected: 'Success',
    operator: 'eq',
    severity: 'high',
    remediationScript: 'auditpol /set /subcategory:"{0CCE9230-69AE-11D9-BED3-505054503030}" /success:enable /failure:disable',
  }),
  r('cis-l1-17-7-3', {
    ...
    operator: 'eq',
    severity: 'high',
    remediationScript: 'auditpol /set /subcategory:"{0CCE9231-69AE-11D9-BED3-505054503030}" /success:enable /failure:disable',
  }),
  r('cis-l1-17-7-4', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(auditpol /get /subcategory:"{0CCE9232-69AE-11D9-BED3-505054503030}" /r | ConvertFrom-Csv | Select-Object -ExpandProperty "Inclusion Setting")',
    expected: 'Success and Failure',
    operator: 'eq',
    severity: 'moderate',
    remediationScript: 'auditpol /set /subcategory:"{0CCE9232-69AE-11D9-BED3-505054503030}" /success:enable /failure:enable',
  }),
  r('cis-l1-17-7-5', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(auditpol /get /subcategory:"{0CCE9234-69AE-11D9-BED3-505054503030}" /r | ConvertFrom-Csv | Select-Object -ExpandProperty "Inclusion Setting")',
    expected: 'Failure',
    operator: 'eq',
    severity: 'moderate',
    remediationScript: 'auditpol /set /subcategory:"{0CCE9234-69AE-11D9-BED3-505054503030}" /success:disable /failure:enable',
  }),
  ...
  r('cis-l1-17-9-1', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(auditpol /get /subcategory:"{0CCE9213-69AE-11D9-BED3-505054503030}" /r | ConvertFrom-Csv | Select-Object -ExpandProperty "Inclusion Setting")',
    expected: 'Success and Failure',
    operator: 'eq',
    severity: 'moderate',
    remediationScript: 'auditpol /set /subcategory:"{0CCE9213-69AE-11D9-BED3-505054503030}" /success:enable /failure:enable',
  }),
  r('cis-l1-17-9-2', {
  ...
  r('cis-l1-17-9-3', {
    ...
    operator: 'eq',
    severity: 'critical',
    remediationScript: 'auditpol /set /subcategory:"{0CCE9210-69AE-11D9-BED3-505054503030}" /success:enable /failure:disable',
  }),
  r('cis-l1-17-9-4', {
    ...
    operator: 'eq',
    severity: 'high',
    remediationScript: 'auditpol /set /subcategory:"{0CCE9211-69AE-11D9-BED3-505054503030}" /success:enable /failure:disable',
  }),
  r('cis-l1-17-9-5', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(auditpol /get /subcategory:"{0CCE9212-69AE-11D9-BED3-505054503030}" /r | ConvertFrom-Csv | Select-Object -ExpandProperty "Inclusion Setting")',
    expected: 'Success and Failure',
    operator: 'eq',
    severity: 'critical',
    remediationScript: 'auditpol /set /subcategory:"{0CCE9212-69AE-11D9-BED3-505054503030}" /success:enable /failure:enable',
  }),
