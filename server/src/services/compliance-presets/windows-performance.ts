...
export const windowsPerformanceRules: ComplianceRule[] = [
  ...
  r('perf-003', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '$v=powercfg /query SCHEME_CURRENT SUB_VIDEO VIDEOIDLE; if($v -match \'0x([0-9a-fA-F]+)\'){$h=[convert]::ToInt32($Matches[1],16); if($h -le 900 -and $h -gt 0){\'PASS\'}else{\'FAIL\'}}else{\'FAIL\'}',
    expected: 'PASS',
    operator: 'eq',
    severity: 'optional',
  ...
  r('perf-071', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '$r=netsh int tcp show global; if($r -match \'Receive Window Auto-Tuning Level\\s*:\\s*normal\'){\'PASS\'}else{\'FAIL\'}',
    expected: 'PASS',
    operator: 'eq',
    severity: 'moderate',
  ...
  r('perf-072', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '$r=netsh int tcp show global; if($r -match \'ECN Capability\\s*:\\s*disabled\'){\'PASS\'}else{\'FAIL\'}',
    expected: 'PASS',
    operator: 'eq',
    severity: 'optional',
  ...
  r('perf-073', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '$r=netsh int tcp show global; if($r -match \'Timestamps\\s*:\\s*disabled\'){\'PASS\'}else{\'FAIL\'}',
    expected: 'PASS',
    operator: 'eq',
    severity: 'optional',
