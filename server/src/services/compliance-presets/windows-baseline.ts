...
export const windowsBaselineRules: ComplianceRule[] = [
  ...
  r('wsb-012', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: `$v=(Get-ItemProperty 'HKLM:\\SOFTWARE\\Microsoft\\Windows Defender\\Spynet' -Name SpynetReporting -EA 0).SpynetReporting; if($v -ne $null -and $v -ne 0){'FAIL'}else{'PASS'}`,
    expected: 'PASS',
    operator: 'eq',
    severity: 'high',
  }),
  ...
  r('wsb-022', {
    ...
    checkType: 'registry',
    targetPlatform: 'windows',
    target: 'HKLM\\SOFTWARE\\Microsoft\\Windows Defender\\Spynet|SpynetReporting',
    expected: '0',
    operator: 'gt',
    severity: 'medium',
  }),
  r('wsb-023', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: `$v=(Get-ItemProperty 'HKLM:\\SOFTWARE\\Microsoft\\Windows Defender\\Spynet' -Name SubmitSamplesConsent -EA 0).SubmitSamplesConsent; if($v -eq 1 -or $v -eq 3){"PASS"}else{"FAIL"}`,
    expected: 'PASS',
    operator: 'eq',
    severity: 'low',
  }),
