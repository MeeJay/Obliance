...
export const windowsBaselineRules: ComplianceRule[] = [
  ...
  r('wsb-018', {
    ...
    checkType: 'registry',
    targetPlatform: 'windows',
    target: 'HKLM\\SOFTWARE\\Policies\\Microsoft\\Windows Defender|PUAProtection',
    expected: '1',
    operator: 'eq',
    severity: 'medium',
  }),
  ...
  r('wsb-020', {
    ...
    checkType: 'registry',
    targetPlatform: 'windows',
    target: 'HKLM\\SOFTWARE\\Policies\\Microsoft\\Windows Defender\\Windows Defender Exploit Guard\\Controlled Folder Access|EnableControlledFolderAccess',
    expected: '1',
    operator: 'eq',
    severity: 'high',
  }),
