...
export const windowsBaselineRules: ComplianceRule[] = [
  ...
  r('wsb-017', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(New-TimeSpan -Start (Get-MpComputerStatus).AntivirusSignatureLastUpdated -End (Get-Date)).Days',
    expected: '7',
    operator: 'lt',
    severity: 'critical',
  }),
  ...
  r('wsb-030', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '((([adsi]"WinNT://localhost").LockoutDuration.Value) / 60)',
    expected: '14',
    operator: 'gt',
    severity: 'high',
  }),
  ...
  r('wsb-035', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '((([adsi]"WinNT://localhost").minPasswordAge.Value) / 86400)',
    expected: '0',
    operator: 'gt',
    severity: 'medium',
  }),
