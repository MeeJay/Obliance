...
export const windowsBaselineRules: ComplianceRule[] = [
  ...
  r('wsb-023', {
    ...
    checkType: 'registry',
    targetPlatform: 'windows',
    target: 'HKLM\\SOFTWARE\\Policies\\Microsoft\\Windows Defender\\Spynet|SubmitSamplesConsent',
    expected: '1',
    operator: 'eq',
    severity: 'low',
  }),
  ...
  r('wsb-087', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(auditpol /get /subcategory:"Sensitive Privilege Use" /r | ConvertFrom-Csv)."Inclusion Setting"',
    expected: 'Success and Failure',
    operator: 'eq',
    severity: 'high',
  }),
  r('wsb-088', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(auditpol /get /subcategory:"Security System Extension" /r | ConvertFrom-Csv)."Inclusion Setting"',
    expected: 'Success and Failure',
    operator: 'eq',
    severity: 'medium',
  }),
  ...
  r('wsb-135', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(auditpol /get /subcategory:"Credential Validation" /r | ConvertFrom-Csv)."Inclusion Setting"',
    expected: 'Success and Failure',
    operator: 'eq',
    severity: 'high',
  }),
  ...
  r('wsb-137', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(auditpol /get /subcategory:"Account Lockout" /r | ConvertFrom-Csv)."Inclusion Setting"',
    expected: 'No Auditing',
    operator: 'neq',
    severity: 'high',
  }),
