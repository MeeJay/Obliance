...
export const windowsBaselineRules: ComplianceRule[] = [
  ...
  r('wsb-017', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '$d=Get-MpComputerStatus -EA SilentlyContinue; if($d -and ((Get-Date)-$d.AntivirusSignatureLastUpdated).TotalDays -le 7){"PASS"}else{"FAIL"}',
    expected: 'PASS',
    operator: 'eq',
    severity: 'critical',
  }),
  ...
  r('wsb-084', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: 'auditpol /get /subcategory:"{0CCE9215-69AE-11D9-BED3-505054503030}" /r | Select-String "0CCE9215" | ForEach-Object { if($_ -match "Success and Failure"){"Success and Failure"}else{""} }',
  ...
  r('wsb-085', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: 'auditpol /get /subcategory:"{0CCE9235-69AE-11D9-BED3-505054503030}" /r | Select-String "0CCE9235" | ForEach-Object { if($_ -match "Success and Failure"){"Success and Failure"}else{""} }',
    expected: 'Success and Failure',
    operator: 'eq',
    severity: 'high',
  ...
  r('wsb-086', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: 'auditpol /get /subcategory:"{0CCE922F-69AE-11D9-BED3-505054503030}" /r | Select-String "0CCE922F" | ForEach-Object { if($_ -match "Success and Failure"){"Success and Failure"}else{""} }',
    expected: 'Success and Failure',
    operator: 'eq',
    severity: 'high',
  ...
  r('wsb-087', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: 'auditpol /get /subcategory:"{0CCE9228-69AE-11D9-BED3-505054503030}" /r | Select-String "0CCE9228" | ForEach-Object { if($_ -match "Success and Failure"){"Success and Failure"}else{""} }',
    expected: 'Success and Failure',
    operator: 'eq',
    severity: 'high',
  ...
  r('wsb-088', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: 'auditpol /get /subcategory:"{0CCE9210-69AE-11D9-BED3-505054503030}" /r | Select-String "0CCE9210" | ForEach-Object { if($_ -match "Success and Failure"){"Success and Failure"}else{""} }',
    expected: 'Success and Failure',
    operator: 'eq',
    severity: 'moderate',
