...
export const pciDSSv4Rules: ComplianceRule[] = [
  ...
  r('pci-7-acc-01', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(auditpol /get /subcategory:"Registry" /r | ConvertFrom-Csv | Select-Object -ExpandProperty "Inclusion Setting")',
    expected: 'Success and Failure',
    operator: 'eq',
    severity: 'high',
  }),
  ...
  r('pci-8-auth-01', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(net accounts | Select-String "Lockout duration").ToString().Split(":")[-1].Trim()',
    expected: '30',
    operator: 'gt',
    severity: 'high',
  }),
  r('pci-8-auth-02', {
    ...
    checkType: 'command',
    targetPlatform: 'windows',
    target: '(net accounts | Select-String "Lockout observation window").ToString().Split(":")[-1].Trim()',
    expected: '30',
    operator: 'gt',
    severity: 'high',
  }),
