...
export function createApp() {
  ...
  const DESKTOP_FILES: Record<string, string> = {
    'Obliance.exe':          'Obliance.exe',          // Windows binary (portable)
    'OblianceSetup.msi':     'OblianceSetup.msi',     // Windows installer (Start Menu shortcut)
    'Obliance-arm64.zip':    'Obliance-arm64.zip',    // macOS Apple Silicon — .app zipped
    'Obliance-amd64.zip':    'Obliance-amd64.zip',    // macOS Intel — .app zipped
    'Obliance-arm64.dmg':    'Obliance-arm64.dmg',    // macOS Apple Silicon — drag-to-Applications DMG
    'Obliance-amd64.dmg':    'Obliance-amd64.dmg',    // macOS Intel — drag-to-Applications DMG
  };
