...
tenantRouter.use('/software-compliance', softwareComplianceRoutes);
tenantRouter.use('/software-repo', softwareRepoRoutes);
...
tenantRouter.use('/restrictions', restrictionRoutes);
