...
function Stepper({ currentStep, steps }: { currentStep: Step; steps: Step[] }) {
 ...
 : 'border-transparent text-text-muted bg-transparent'
 }`}
 >
...
function LanguageStep({ selected, onSelect }: { selected: string; onSelect: (code: string) => void }) {
 ...
 : 'border-transparent hover:border-primary/50 hover:bg-bg-hover text-text-secondary'
 }`}
 >
...
function AlertPreviewSvg({ position }: { position: 'bottom-right' | 'top-center' }) {
 return (
 <svg viewBox="0 0 200 120" className="w-full max-w-xs mx-auto rounded-lg bg-bg-primary">
 {/* Screen body */}
...
function AlertsStep({
 ...
 />
 <div className="w-9 h-5 rounded-full border-2 border-transparent peer-checked:border-primary peer-checked:bg-primary bg-bg-hover transition-colors" />
 ...
 position === pos ? 'border-primary bg-primary/10' : 'border-transparent hover:border-primary/50 hover:bg-bg-hover'
 }`}
 >
 <div className="flex items-center gap-2 mb-2">
 <div className={`h-4 w-4 rounded-full border-2 flex items-center justify-center ${position === pos ? 'border-primary' : 'border-transparent'}`}>
...
function SecurityStep({
 ...
 className="w-full flex items-center justify-between rounded-lg hover:border-primary/50 hover:bg-bg-hover p-4 text-left transition-colors group"
 >
 <div>
...
export function EnrollmentPage() {
 ...
 <img src="/logo.svg" alt="Obliance" className="mx-auto h-20 w-20 mb-3" />
