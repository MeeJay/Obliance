...
export function SettingsPage() {
 ...
 setAppConfig((prev) => prev ? { ...prev, [key]: String(value) } : prev);
 } catch {
 ...
 {servers.length === 0 ? (
 <div className="rounded-lg bg-bg-secondary p-5 text-sm text-text-muted flex items-center gap-3">
...
function EditableExtensionsSection() {
 ...
 <div className="rounded-lg bg-bg-secondary p-5 space-y-3">
...
function ScenariosBulkSection() {
 ...
 {importResult && (
 <div className="rounded-lg p-3 bg-bg-tertiary/50 space-y-1">
