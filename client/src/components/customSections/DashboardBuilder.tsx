...
export function DashboardBuilder({ runtime, initialCommand, initialTitle, onClose, onInsert }: Props) {
 ...
 className={clsx('p-2.5 text-left rounded-lg border transition-colors', sourceKind === 'file' ? 'bg-accent/10 border-accent text-accent' : 'border-transparent text-text-muted hover:border-accent/50')}>
 ...
 className="w-20 px-2 py-1 text-xs bg-bg-tertiary rounded focus:outline-none focus:border-accent" />
 )}
 </div>
 </div>
 )}
 ...
 className="text-xs bg-bg-tertiary rounded px-2 py-1 text-text-primary focus:outline-none focus:border-accent">
 ...
 against the sample. */}
 {format === 'regex' && (
 <div className="flex items-center gap-2 flex-wrap p-2 rounded bg-bg-tertiary/30">
 ...
 className="bg-bg-primary rounded px-1.5 py-0.5 text-[11px] text-text-primary focus:outline-none focus:border-accent">
 ...
 className="w-14 px-1.5 py-0.5 bg-bg-primary rounded text-[10px] text-text-primary focus:outline-none focus:border-accent ml-1" />
 )}
 </label>
 )}
 ...
 {generated && (
 <div className="rounded-lg overflow-hidden">
 <div className="px-3 py-1.5 bg-bg-tertiary/40 text-[11px] font-mono uppercase text-text-muted">
