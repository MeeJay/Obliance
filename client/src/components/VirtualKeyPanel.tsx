...
export function VirtualKeyPanel({ onKey, className }: Props) {
 ...
 className="min-w-[36px] px-2 py-1 text-[11px] font-mono font-semibold bg-bg-tertiary rounded hover:bg-accent/10 hover:border-accent/40 hover:text-accent transition-colors"
 >
 {k.label}
 </button>
 ))}
