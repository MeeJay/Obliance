...
export function GroupTreePicker({ value, onChange, className }: GroupTreePickerProps) {
 ...
 className="flex items-center gap-2 px-3 py-1.5 text-sm bg-bg-secondary rounded-lg text-text-primary hover:border-accent/50 transition-colors min-w-[120px]"
 >
 <FolderOpen className="w-3.5 h-3.5 text-text-muted shrink-0" />
 ...
 {open && (
 <div className="absolute top-full left-0 mt-1 z-50 w-64 max-h-80 overflow-y-auto bg-bg-secondary rounded-lg shadow-lg p-1">
 <button
 onClick={clear}
 className={clsx(
 'w-full flex items-center gap-1.5 px-2 py-1.5 text-xs rounded transition-colors text-left',
