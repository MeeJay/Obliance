...
export function NotificationChannelBindings({ value, onChange }: Props) {
 ...
 key={ch.id}
 className={clsx(
 'flex items-center gap-3 px-4 py-3 last:border-b-0 transition-colors',
 ...
 {bound && (
 <div className="flex items-center rounded-full bg-bg-tertiary border border-transparent overflow-hidden shrink-0">
 ...
 : 'border-transparent text-text-muted hover:text-text-primary hover:border-accent/40',
 )}
 >
 {bound ? 'Unbind' : 'Bind'}
 </button>
