...
export function GroupPicker({ value, onChange, tree, placeholder = 'Select a group', excludeId, kindFilter }: GroupPickerProps) {
 ...
 className="flex w-full items-center justify-between rounded-md bg-bg-tertiary px-3 py-2 text-sm text-text-primary focus:outline-none focus:ring-2 focus:ring-accent"
 >
