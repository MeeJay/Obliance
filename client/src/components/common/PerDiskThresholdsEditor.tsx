      ...
      {eligible.map((d) => {
        ...
        return (
          <div key={d.mount} className={clsx(
            'p-2 rounded border border-border bg-bg-tertiary/40 flex items-center gap-2',
            ...
            {isOverridden && (
              <div className="flex items-center gap-1 shrink-0">
                <input
                  ...
                  className="w-14 px-1.5 py-0.5 text-xs bg-bg-primary border border-border rounded text-amber-400 text-center font-mono focus:outline-none focus:border-accent"
                ...
                <input
                  ...
                  className="w-14 px-1.5 py-0.5 text-xs bg-bg-primary border border-border rounded text-red-400 text-center font-mono focus:outline-none focus:border-accent"
