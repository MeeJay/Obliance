...
export function ObliReachViewer({
 ...
 return (
 <div className="relative rounded bg-bg-tertiary" style={{ width: boxW, height: Math.max(boxH, 20) }} title="Select monitor">
 {monitors.map(m => {
 ...
 title="Video codec"
 className="px-2 py-1 text-xs bg-bg-secondary text-text-muted rounded hover:text-text-primary transition-colors cursor-pointer"
 >
 ...
 className="flex items-center gap-1.5 px-2 py-1 text-xs bg-bg-secondary text-text-muted rounded hover:text-text-primary hover:bg-bg-tertiary disabled:opacity-40 transition-colors"
 >
 ...
 <button
 onClick={handleClose}
 className="mt-2 px-4 py-2 bg-bg-secondary text-text-primary rounded-lg hover:bg-bg-tertiary transition-colors text-sm"
 >
 Close
 </button>
 </div>
