...
func pollCommandsOnce(cfg *Config) int {
	...
	// The agent no longer auto-applies result.LatestVersion — updates are
	// admin-triggered via the update_agent command. The field is still reported
	// upstream for the "update available" UI badge.
